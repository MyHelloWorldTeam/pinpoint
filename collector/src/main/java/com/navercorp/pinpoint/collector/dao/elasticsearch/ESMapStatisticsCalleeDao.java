...
public class ESMapStatisticsCalleeDao implements MapStatisticsCalleeDao {
    ...
    public void flushAll() {
        ...
        remove.entrySet().stream().forEach(p->{
            ...
            CallerColumnName rc = (CallerColumnName) r.getColumnName();
            Long l = p.getValue();
            ...
            json.put("callerApplicationName",rc.callerApplicationName);
            json.put("callerServiceType",rc.callerServiceType);
